        ...
        <div class="is-header">
          <div class="columns">
            <div class="column">
              ...
              <p class="prenom is-hidden-touch" style="margin-top:-20px"><span class="bjr">Bonjour </span><?php echo $_SESSION["prenom"]; ?> <a href="disconnect.php" style="color:white"><i class="fas fa-sign-out-alt"></i></a><a href="modifyPassword.php" style="color:white"><i class="fas fa-key"></i><?php if($_SESSION["role"]=="admin")echo '<a href="dashboard.php" style="color:white"><i class="fas fa-cog"></i></a>'; ?></p>
              <p class="prenom is-hidden-desktop" style="margin-top:-20px;font-size:20px;"><span class="bjr">Bonjour </span><?php echo $_SESSION["prenom"]; ?> <a href="disconnect.php" style="color:white"><i class="fas fa-sign-out-alt"></i></a><a href="modifyPassword.php" style="color:white"><i class="fas fa-key"></i></a><?php if($_SESSION["role"]=="admin")echo '<a href="dashboard.php" style="color:white"><i class="fas fa-cog"></i></a>'; ?></p>
            </div>
